...
#iv_spot_rv_m.drop(['1.03.2020','1.05.2020','1.04.2020','1.06.2020'],inplace=True)
...
#spot_rv_co_m.drop(['1.03.2020','1.05.2020','1.04.2020','1.06.2020'],inplace=True)
#df5.drop(['1.03.2020','1.05.2020','1.04.2020','1.06.2020'],inplace=True)
#df6.drop(['1.03.2020','1.05.2020','1.04.2020','1.06.2020'],inplace=True)
...
variables = {
    ...
    'CO6': spot_rv_co['CO6'],
    'CO9': spot_rv_co['CO9'],
    'CO12': spot_rv_co['CO12'],
    'BRENT':  iv_spot_rv['BRENT']
}
...
print(df)
df.to_excel(r'tablo\descriptive_stats_month_co.xlsx', index=False)
