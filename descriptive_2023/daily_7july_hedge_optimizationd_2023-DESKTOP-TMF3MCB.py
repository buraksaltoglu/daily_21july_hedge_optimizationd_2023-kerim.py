...
optimal_h = hs[np.argmax(var_values)]
...
optimal_h = hs[np.argmax(es_values)]
print("Optimal Hedge Ratio:", optimal_h)
...
varunhedged = np.percentile(df2['brent_ret'], 5)
varhedged = np.percentile(portfolio_returns_optimal, 5)
print(varunhedged)
print(varhedged)
