...
def write_to_csv(data, file_name: str):
...
def sfs_backward(data_set, target: str, n_features: int, scoring: str, file_name: str):
    ...
    for e in feature_matrix:
        print(e)
        print("\n")
    write_to_csv(data=feature_matrix, file_name=file_name)
...
update_data_set(data_set=sentiments, target="RV30", regressors_for_data_set=regressors, n_features_to_select=3,
                directory_name="updated_data_sets", file_name="updated_sentiments_feature_set_30", threshold=7)
...
# Example usage for feature_set_selector is below:
sfs_backward(data_set=sentiments, target="RV30", scoring="r2", n_features=5,
             file_name="sentiments_RV30_features_sfs_backward")
