...
data_brent=  pd.read_csv(r"data\data_mixed.csv", encoding='utf-8', sep=',')
##############################################################################################################
...
for name, regresor in regresors.items ( ):
    ...
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV60'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
...
for name, regresor in regresors.items ( ):
    ...
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV30'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
plt.title("MSE: RV30 with Only finance Data")
...
for name, regresor in regresors.items ( ):
    ...
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV60'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
plt.title("MSE: RV60 with Only finance Data")
#plt.savefig('graph\box_rv60_fin.png')
plt.show()
...
for name, regresor in regresors.items ( ):
    ...
    r2=cross_val_score(model,X, y, cv=5, scoring='r2')
    mse = cross_val_score(model, X, y, cv=5, scoring='neg_mean_squared_error')
    scores_finance=scores_finance.append({'regressor':name,'r2':r2.mean(),'mse':-mse.mean(),'RV':'RV90'},ignore_index=True)
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV90'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
plt.title("MSE: RV90 with Only finance Data")
#plt.savefig('graph\box_rv60_fin.png')
plt.show()
...
for name, regresor in regresors.items ( ):
    ...
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV30'},ignore_index=True)    
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
plt.title("MSE: RV30 with Only macro Data")
...
plt.title("MSE: RV60 with Only macro Data")
plt.show()
...
plt.title("MSE: RV90 with Only macro Data")
plt.show()
...
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
plt.title("MSE: RV30 with mixed Data")
...
for name, regresor in regresors.items ( ):
    ...
    r2=cross_val_score(model,X, y, cv=5, scoring='r2')
    mse = cross_val_score(model, X, y, cv=5, scoring='neg_mean_squared_error')
    scores_mixed=scores_mixed.append({'regressor':name,'r2':r2.mean(),'mse':mse.mean(),'RV':'RV60'},ignore_index=True)
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV60'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
#plt.savefig('graph\box_rv60_mix.png')
plt.title("MSE: RV60 with macro finance  Data")
plt.show()
...
for name, regresor in regresors.items ( ):
    ...
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV90'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
plt.title("MSE: RV90 with mixed Data")
...
for name, regresor in regresors.items ( ):
    ...
    r2=cross_val_score(model,X, y, cv=5, scoring='r2')
    mse = cross_val_score(model, X, y, cv=5, scoring='neg_mean_squared_error')
    scores_rp=scores_rp.append({'regressor':name,'scores_r2':r2.mean(),'scores_mse':-mse.mean(),'RP':'RP30'},ignore_index=True)
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV30'},ignore_index=True)    
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
...
for name, regresor in regresors.items ( ):
    ...
    r2=cross_val_score(model,X, y, cv=5, scoring='r2')
    mse = cross_val_score(model, X, y, cv=5, scoring='neg_mean_squared_error')
    scores_rp=scores_rp.append({'regressor':name,'scores_r2':r2.mean(),'scores_mse':-mse.mean(),'RP':'RP60'},ignore_index=True)
    b_plot=b_plot.append({'regressor':name,'r2':r2,'mse':mse,'RV':'RV60'},ignore_index=True)
plt.boxplot(-b_plot.mse,labels=regresors.keys(), showmeans=True, notch=True, patch_artist=True)
#plt.savefig('graph\box_rp60.png')
plt.title("MSE: RV60 with Only rp Data")
plt.show()
y=data_finance.RV90
X=data_finance.shift(1).dropna()
y=y.drop(y.index[0])
...
plt.title("MSE: RV90 with rp Data")
plt.show()
